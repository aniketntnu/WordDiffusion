...
def main():
    ...
    parser.add_argument('--save_path', type=str, default='/cluster/datastore/aniketag/allData/syntheticData/train/Mse_Style_text_condi_FromScratch/0/')
    ...
    parser.add_argument('--stable_dif_path', type=str, default="/cluster/datastore/aniketag/WordStylist/stableDiffusion/")
    parser.add_argument('--models_path', type=str, default='/cluster/datastore/aniketag/allData/wordStylist/models/IAM/Mse_Style_text_condi_FromScratch/models/')
    ...
    if args.latent == True:
        ...
        unet = UNetModel(image_size = args.img_size, in_channels=args.channels,
                        ...
                        channel_mult=(1, 1), num_heads=args.num_heads, num_classes=339,
                        context_dim=args.emb_dim, vocab_size=vocab_size, 
                        args=args, max_seq_len=10).to(args.device)    
