...
from utils.dataGenerationGWConfig import *
...
logging.basicConfig(
    ...
    level=logging.INFO,
    handlers=[
        logging.FileHandler('./logs/GWGenerationLogs.log'),  # Add a FileHandler
        logging.StreamHandler()  # Add a StreamHandler for console output
    ]
)
logger = logging.getLogger('')
logger.info('--- GWGeneration ---')
...
def main():
    ...
    parser.add_argument('--batch_size', type=int, default=2)# batchSize
    parser.add_argument('--num_workers', type=int, default=8) 
    parser.add_argument('--img_size', type=int, default=(64, 256))  

    parser.add_argument('--gtPath', type=str, default="./gt/converted_data.filter27") 
    #UNET parameters
    ...
    parser.add_argument('--save_path', type=str, default="/cluster/datastore/aniketag/allData/syntheticData/train/GW/") # './wordStyleOutPut_600_preprocess_0/'
    ...
    parser.add_argument('--loadPrevPath', type=str, default="/cluster/datastore/aniketag/allData/wordStylist/models/GW/GW_Mse_text_condi_FromScratch/models/ema_GW_Mse_text_condi_FromScratch.pt")
    ...
    parser.add_argument('--stopFlag', type=str, default = "./flags/stopFlagGW.txt",help ="flag to stop program") # partialLoad
