...
# Set CUDA_VISIBLE_DEVICES to specify the GPU device (e.g., GPU 0)
...
class IAMDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return image,wrdChrWrStyl, word_embedding, wr_id
...
def train(diffusion, model, ema, ema_model, vae, optimizer, mse_loss, loader, num_classes, vocab_size, transforms, args):
    ...
    for epoch in range(args.epochs):
        ...
        for i, (images,wrdChrWrStyl, word, s_id) in enumerate(pbar):
            ...
            predicted_noise = model(x_t,wrdChrWrStyl, original_images=original_images, timesteps=t, context=text_features, y=s_id, or_images=None)
